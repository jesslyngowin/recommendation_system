...
// Define questions for RIASEC Likert test
var riasecQuestions = [
...
// Get a reference to the RIASEC likert-container
var riasecContainer = document.getElementById("riasec-container");

// Loop through the RIASEC questions array
riasecQuestions.forEach(function (question, index) {
    // Create a div element for each RIASEC question
    ...
    <div class="options">
        <ul class="likert">
        <li>
            <input type="radio" name="riasec${index}" value="sangat_tidak_setuju">
            <label>Sangat Tidak Setuju</label>
        </li>
        <li>
            <input type="radio" name="riasec${index}" value="tidak_setuju">
            <label>Tidak Setuju</label>
        </li>
        <li>
            <input type="radio" name="riasec${index}" value="agak_setuju">
            <label>Agak Setuju</label>
        </li>
        <li>
            <input type="radio" name="riasec${index}" value="setuju">
            <label>Setuju</label>
        </li>
        <li>
            <input type="radio" name="riasec${index}" value="sangat_setuju">
            <label>Sangat Setuju</label>
        </li>
        </ul>
    </div>`;

    // Append the questionDiv to the RIASEC likert-container
    riasecContainer.appendChild(questionDiv);

    // Function to submit RIASEC test
function submitRIASEC() {
  // Collect RIASEC test responses
  var responses = [];
...
// Define questions for Tipe Kecerdasan test
...
// Get a reference to the Kecerdasan likert-container
var kecerdasanContainer = document.getElementById("tipe-kecerdasan-container");

// Loop through the Kecerdasan questions array
kecerdasanQuestions.forEach(function (question, index) {
    // Create a div element for each Kecerdasan question
    var questionDiv = document.createElement("div");
    questionDiv.classList.add("row", "question");
    questionDiv.innerHTML = `
    <label class="statement">${question.statement}</label>
    <div class="options">
      <ul class="likert">
        <li>
          <input type="radio" name="tipe-kecerdasan${index}" value="sangat_tidak_setuju">
          <label>Sangat Tidak Setuju</label>
        </li>
        <li>
          <input type="radio" name="tipe-kecerdasan${index}" value="tidak_setuju">
          <label>Tidak Setuju</label>
        </li>
        <li>
          <input type="radio" name="tipe-kecerdasan${index}" value="agak_setuju">
          <label>Agak Setuju</label>
        </li>
        <li>
          <input type="radio" name="tipe-kecerdasan${index}" value="setuju">
          <label>Setuju</label>
        </li>
        <li>
          <input type="radio" name="tipe-kecerdasan${index}" value="sangat_setuju">
          <label>Sangat Setuju</label>
        </li>
      </ul>
    </div>`;

    // Append the questionDiv to the Kecerdasan likert-container
